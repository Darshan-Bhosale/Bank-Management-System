...
void see(void){
    ...
    test=1;
        ...
        printf("\n\nYou will get INR%.2f as interest on %d/%d/%d",intrst,add.deposit.month,add.deposit.day,add.deposit.year+1);
        }
        ...
        rate=11;
        intrst=interest(time,add.amt,rate);
        printf("\n\nYou will get INR.%.2f as interest on %d/%d/%d",intrst,add.deposit.month,add.deposit.day,add.deposit.year+2);
		}
        ...
        rate=13;
        intrst=interest(time,add.amt,rate);
        printf("\n\nYou will get INR.%.2f as interest on %d/%d/%d",intrst,add.deposit.month,add.deposit.day,add.deposit.year+3);
		}
...
void close(){
    printf("\n\n\n\nThis C Mini Project is developed by Darshan Bhosale!");
}		
...
{   int choice;
    ...
    //system("color 9");
    menu:
	printf("\n\n\t\t\t   \xB2\xB3\BANK MANAGEMENT SYSTEM\xB3\xB2");
